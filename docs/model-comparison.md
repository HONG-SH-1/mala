...
| Phase 4 라우터 | **PoC:** Hermes3 8B (`hermes3:8b`) — peak **7418 MiB**, `ollama ps` 5.2 GB — **Qwen과 동시 적재 금지** |

상세 과정: [`../troubleshooting/2026-05-20-moe-vram.md`](../troubleshooting/2026-05-20-moe-vram.md) · Phase 4: [`decisions/003-phase4-hermes-router.md`](decisions/003-phase4-hermes-router.md)
...
| Hermes 3 8B (`hermes3:8b`) | GGUF (Ollama) | 8B FC router | ~5–7 GB (문헌) | ⚠️ | Tool 라우터 (Phase 4) | **2026-05-26:** ctx **4096** · `ollama ps` **5.2 GB** · `nvidia-smi` peak **7418 MiB** / 10240 (여유 **~2.8 GB**) · Qwen과 **동시 상주 금지** (ADR-003) | Phase 4 PoC · tool은 폴백 검색 병행 |
